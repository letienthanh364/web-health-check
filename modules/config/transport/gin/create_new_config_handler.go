...
import (
	...
	bizconfig "github.com/teddlethal/web-health-check/modules/config/biz"
	configmodel "github.com/teddlethal/web-health-check/modules/config/model"
	storageconfig "github.com/teddlethal/web-health-check/modules/config/storage"
	"gorm.io/gorm"
	"net/http"
)
...
func CreateConfig(db *gorm.DB) func(ctx *gin.Context) {
	return func(c *gin.Context) {
		...
		business := bizconfig.CreateConfigStorage(store)
